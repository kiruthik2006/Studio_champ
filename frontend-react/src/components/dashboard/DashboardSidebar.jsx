 ...
 * - AI Neural Engine telemetry & storage capacity card
 */
export const DashboardSidebar = ({
  ...
  return (
    <aside className="dashboard-sidebar" style={{ width: '280px', minWidth: '280px', display: 'flex', flexDirection: 'column', gap: '1.25rem', overflowY: 'auto' }}>
      ...
      {/* 4. AI Engine & Matching Telemetry Card */}
      <div
        style={{
          padding: '0.85rem',
      ...
      >
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', color: 'var(--text-muted)', fontSize: '0.72rem' }}>
          ...
          <span style={{ fontWeight: 600, color: 'var(--text-main)' }}>0.40 (99.2% Acc)</span>
        </div>

        <div style={{ display: 'flex', justifyContent: 'space-between', color: 'var(--text-muted)', fontSize: '0.72rem' }}>
          <span>Multi-Person Engine</span>
          <span style={{ fontWeight: 600, color: 'var(--primary)' }}>Boolean AND/OR</span>
        </div>
      </div>

      {/* 5. Footer & Quick Logout */}
      <div
        style={{
          display: 'flex',
          alignItems: 'center',
